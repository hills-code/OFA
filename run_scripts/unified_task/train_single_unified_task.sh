...
task=unified_text_cls
dataset_name=rte
log_dir=./logs/${task}/${dataset_name}
save_dir=./checkpoints/${task}/${dataset_name}
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=../../dataset/unified_data/${dataset_name}
data=${data_dir}/train.tsv,${data_dir}/dev.tsv
...
ans2label_dict=${data_dir}/ans2label.pkl
